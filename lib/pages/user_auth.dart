          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                ...
                } , child: isLogin ? Text("Login",style: TextStyle(color: Colors.white),) : Text("Signup",style: TextStyle(color: Colors.white),),style:ElevatedButton.styleFrom(shape: RoundedRectangleBorder(borderRadius: BorderRadius.zero),backgroundColor: Colors.green))),
                SizedBox(
                  height: 10,
                ),
